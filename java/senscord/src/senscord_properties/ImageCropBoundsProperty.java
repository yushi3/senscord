 ...
 */
public class ImageCropBoundsProperty extends Structure {
    public int left;
    public int top;
    public int width;
    public int height;

    public static class ByReference extends ImageCropBoundsProperty implements Structure.ByReference {
    }
