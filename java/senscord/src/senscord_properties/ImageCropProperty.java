...
/**
 * Property for image cropping.
 * 
 * @see "senscord::ImageCropProperty"
 */
public class ImageCropProperty extends Structure {
    public int left;
    public int top;
    public int width;
    public int height;

    public static class ByReference extends ImageCropProperty implements Structure.ByReference {
    }
