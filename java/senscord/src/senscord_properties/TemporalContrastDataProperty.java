...
public class TemporalContrastDataProperty extends Structure {

    public static interface TemporalContrastTriggerType {
    ...
    public static class ByReference extends TemporalContrastDataProperty implements Structure.ByReference {
    }
    ...
    public TemporalContrastDataProperty() {
        super();
    }
