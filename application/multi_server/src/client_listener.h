 ...
 */
#ifndef APPLICATION_MULTI_SERVER_CLIENT_LISTENER_H_
#define APPLICATION_MULTI_SERVER_CLIENT_LISTENER_H_
...
class ClientListenerBase : private util::Noncopyable {
 ...
 protected:
  ...
  virtual ClientAdapterBase* CreateAdapter(
      ...
      const std::string& connection_key) = 0;
...
#endif  // APPLICATION_MULTI_SERVER_CLIENT_LISTENER_H_
