 ...
 */
#ifndef APPLICATION_MULTI_SERVER_CLIENTLESS_CORE_BEHAVIOR_H_
#define APPLICATION_MULTI_SERVER_CLIENTLESS_CORE_BEHAVIOR_H_
...
#endif  // APPLICATION_MULTI_SERVER_CLIENTLESS_CORE_BEHAVIOR_H_
