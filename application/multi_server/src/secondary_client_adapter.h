 ...
 */
#ifndef APPLICATION_MULTI_SERVER_SECONDARY_CLIENT_ADAPTER_H_
#define APPLICATION_MULTI_SERVER_SECONDARY_CLIENT_ADAPTER_H_
...
#endif  // APPLICATION_MULTI_SERVER_SECONDARY_CLIENT_ADAPTER_H_
