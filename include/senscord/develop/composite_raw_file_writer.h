 ...
 */
#ifndef SENSCORD_DEVELOP_COMPOSITE_RAW_FILE_WRITER_H_
#define SENSCORD_DEVELOP_COMPOSITE_RAW_FILE_WRITER_H_
...
// internal class
class RawIndexFileWriter;
class ChannelPropertiesFileWriter;

/**
 * @brief File writer for composite raw files.
 */
class CompositeRawFileWriter : private util::Noncopyable {
 public:
  /**
...
#endif  // SENSCORD_DEVELOP_COMPOSITE_RAW_FILE_WRITER_H_
