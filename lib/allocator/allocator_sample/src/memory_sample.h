 ...
 */
#ifndef LIB_ALLOCATOR_ALLOCATOR_SAMPLE_SRC_MEMORY_SAMPLE_H_
#define LIB_ALLOCATOR_ALLOCATOR_SAMPLE_SRC_MEMORY_SAMPLE_H_
 ...
 * Memory sample.
 */
class SampleMemory : public Memory {
 public:
  /**
   * @brief Constructor.
   ...
   */
  explicit SampleMemory(uintptr_t address, size_t size,
   ...
   * @brief Destructor.
   */
  virtual ~SampleMemory() {}

  /**
   * @brief Get memory block pointer.
...
#endif  // LIB_ALLOCATOR_ALLOCATOR_SAMPLE_SRC_MEMORY_SAMPLE_H_
