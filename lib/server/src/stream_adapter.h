 ...
 */
#ifndef LIB_SERVER_STREAM_ADAPTER_H_
#define LIB_SERVER_STREAM_ADAPTER_H_
 ...
 */
class StreamAdapter : private util::Noncopyable {
 public:
  enum MonitorType {
    kMonitorStandard = 0,
    kMonitorLockUnlock,
   ...
   */
  void Monitoring(MonitorType type);
 ...
 private:
  typedef std::vector<const Message*> MessageList;
...
#endif  // LIB_SERVER_STREAM_ADAPTER_H_
