 ...
 */
#ifndef LIB_CORE_RECORD_SKV_RECORDER_SKV_CONFIDENCE_CHANNEL_RECORDER_H_
#define LIB_CORE_RECORD_SKV_RECORDER_SKV_CONFIDENCE_CHANNEL_RECORDER_H_
 ...
 */
class SkvConfidenceChannelRecorder : public SkvChannelRecorder {
 public:
  /**
   * @brief Constructor
   */
  SkvConfidenceChannelRecorder();
 ...
 private:
  ...
  Status SetRawDataStreamInfo(
    const ConfidenceProperty& property,
...
#endif    // LIB_CORE_RECORD_SKV_RECORDER_SKV_CONFIDENCE_CHANNEL_RECORDER_H_
