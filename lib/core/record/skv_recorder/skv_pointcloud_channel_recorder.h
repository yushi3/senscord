 ...
 */
#ifndef LIB_CORE_RECORD_SKV_RECORDER_SKV_POINTCLOUD_CHANNEL_RECORDER_H_
#define LIB_CORE_RECORD_SKV_RECORDER_SKV_POINTCLOUD_CHANNEL_RECORDER_H_
 ...
 */
class SkvPointCloudChannelRecorder : public SkvChannelRecorder {
 public:
  /**
   * @brief Constructor
   */
  SkvPointCloudChannelRecorder();
 ...
 private:
  ...
  Status SetRawDataStreamInfo(
    const PointCloudProperty& property,
   ...
   */
  void ConvertPixelFormat(BinaryProperty* binary_property);

  SkvCustomStreamInfo rawdata_stream_info_;
  SkvCustomStreamInfo property_stream_info_;
  PointCloudProperty point_cloud_;
};

}   // namespace senscord
#endif    // LIB_CORE_RECORD_SKV_RECORDER_SKV_POINTCLOUD_CHANNEL_RECORDER_H_
