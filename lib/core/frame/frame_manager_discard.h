 ...
 */
#ifndef LIB_CORE_FRAME_FRAME_MANAGER_DISCARD_H_
#define LIB_CORE_FRAME_FRAME_MANAGER_DISCARD_H_
...
/**
 * @brief Manages Frame : Discard
 */
class FrameManagerDiscard : public FrameManagerCore {
 public:
  /**
   * @brief Constructor.
   */
...
#endif  // LIB_CORE_FRAME_FRAME_MANAGER_DISCARD_H_
