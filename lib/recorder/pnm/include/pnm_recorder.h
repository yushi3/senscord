 ...
 */
#ifndef LIB_RECORDER_PNM_INCLUDE_PNM_RECORDER_H_
#define LIB_RECORDER_PNM_INCLUDE_PNM_RECORDER_H_
...
/**
 * @brief Recorder for pnm format.
 */
class PnmRecorder : public senscord::ChannelRecorder {
 public:
  /**
 ...
 protected:
   ...
   */
  virtual PnmChannelRecorder* CreateChannelRecorder(
 ...
 private:
  ...
  // recorder
  PnmChannelRecorder* recorder_;
};

#endif  // LIB_RECORDER_PNM_INCLUDE_PNM_RECORDER_H_
