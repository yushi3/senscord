 ...
 */
senscord::Status SenscordDepthChannelAccessor::Init(
 ...
 */
senscord::Status SenscordDepthChannelAccessor::CacheRawData() {
 ...
 * @return Status object.
 */
senscord::Status SenscordDepthChannelAccessor::GetValidFrameInfo(
  ...
  if (property_time_stamp_ + frame_interval_ >= current_time_stamp) {
    // current_time_stamp >= property_time_stamp is guaranteed.
 ...
 * @return Status object.
 */
senscord::Status SenscordDepthChannelAccessor::UpdateProperty(
 ...
 * @return Status object.
 */
senscord::Status SenscordDepthChannelAccessor::GetAllFrameTimestamp(
 ...
 * @return Status object.
 */
senscord::Status SenscordDepthChannelAccessor::SetFrameInterval(
  uint64_t interval) {
    if (interval <= 0) {
 ...
 * @return Status object.
 */
senscord::Status SenscordDepthChannelAccessor::ResetFrameIndex() {
 ...
 * @return Status object.
 */
senscord::Status SenscordDepthChannelAccessor::GetRawData(
  ...
  channel_raw_data->data_type          = senscord::kRawDataTypeDepth;
 ...
 * @brief Constructor.
 */
SenscordDepthChannelAccessor::SenscordDepthChannelAccessor():
