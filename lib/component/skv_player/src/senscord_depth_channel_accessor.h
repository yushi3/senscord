 ...
 */
#ifndef LIB_COMPONENT_SKV_PLAYER_SRC_SENSCORD_DEPTH_CHANNEL_ACCESSOR_H_
#define LIB_COMPONENT_SKV_PLAYER_SRC_SENSCORD_DEPTH_CHANNEL_ACCESSOR_H_
 ...
 */
class SenscordDepthChannelAccessor : public SkvPlayBaseChannelAccessor {
 public:
  /**
   ...
   * @param[out] (property_frame_index) valid property frame
   *                                    index for a given time stamp.
...
#endif  // LIB_COMPONENT_SKV_PLAYER_SRC_SENSCORD_DEPTH_CHANNEL_ACCESSOR_H_
