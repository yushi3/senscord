 ...
 */
#ifndef LIB_COMPONENT_SKV_PLAYER_SRC_SENSCORD_POINTCLOUD_CHANNEL_ACCESSOR_H_
#define LIB_COMPONENT_SKV_PLAYER_SRC_SENSCORD_POINTCLOUD_CHANNEL_ACCESSOR_H_
 ...
 */
class SenscordPointCloudChannelAccessor : public SkvPlayBaseChannelAccessor {
 public:
  /**
 ...
 */
 ...
 public:
   ...
   * @brief Constructor.
   */
  SenscordPointCloudChannelAccessor();
...
#endif  // LIB_COMPONENT_SKV_PLAYER_SRC_SENSCORD_POINTCLOUD_CHANNEL_ACCESSOR_H_
