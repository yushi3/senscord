 ...
 */
senscord::Status SenscordPointCloudChannelAccessor::Init(
 ...
 */
senscord::Status SenscordPointCloudChannelAccessor::CacheRawData() {
 ...
 * @return Status object.
 */
senscord::Status SenscordPointCloudChannelAccessor::GetValidFrameInfo(
 ...
 * @return Status object.
 */
senscord::Status SenscordPointCloudChannelAccessor::UpdateProperty(
 ...
 * @return Status object.
 */
senscord::Status SenscordPointCloudChannelAccessor::GetAllFrameTimestamp(
 ...
 * @return Status object.
 */
senscord::Status SenscordPointCloudChannelAccessor::SetFrameInterval(
    uint64_t interval) {
  if (interval <= 0) {
 ...
 * @return Status object.
 */
senscord::Status SenscordPointCloudChannelAccessor::ResetFrameIndex() {
 ...
 * @return Status object.
 */
senscord::Status SenscordPointCloudChannelAccessor::GetRawData(
  ...
  channel_raw_data->data_type          = senscord::kRawDataTypePointCloud;
 ...
 * @brief Constructor.
 */
SenscordPointCloudChannelAccessor::SenscordPointCloudChannelAccessor():
