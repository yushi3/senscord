 ...
 */
senscord::Status SenscordRawdataChannelAccessor::Init(
 ...
 */
senscord::Status SenscordRawdataChannelAccessor::CacheRawData() {
 ...
 * @return Status object.
 */
senscord::Status SenscordRawdataChannelAccessor::GetValidFrameInfo(
 ...
 * @return Status object.
 */
senscord::Status SenscordRawdataChannelAccessor::UpdateProperty(
 ...
 * @return Status object.
 */
senscord::Status SenscordRawdataChannelAccessor::GetAllFrameTimestamp(
 ...
 * @return Status object.
 */
senscord::Status SenscordRawdataChannelAccessor::SetFrameInterval(
    uint64_t interval) {
  if (interval <= 0) {
 ...
 * @return Status object.
 */
senscord::Status SenscordRawdataChannelAccessor::ResetFrameIndex() {
 ...
 * @return Status object.
 */
senscord::Status SenscordRawdataChannelAccessor::GetRawData(
  ...
  channel_raw_data->data_type          = senscord::kRawDataTypeImage;
 ...
 * @brief Constructor.
 */
SenscordRawdataChannelAccessor::SenscordRawdataChannelAccessor():
