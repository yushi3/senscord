 ...
 */
#ifndef LIB_COMPONENT_SKV_PLAYER_SRC_SENSCORD_CONFIDENCE_CHANNEL_ACCESSOR_H_
#define LIB_COMPONENT_SKV_PLAYER_SRC_SENSCORD_CONFIDENCE_CHANNEL_ACCESSOR_H_
 ...
 */
class SenscordConfidenceChannelAccessor : public SkvPlayBaseChannelAccessor {
 public:
  /**
 ...
 public:
   ...
   * @brief Constructor.
   */
  SenscordConfidenceChannelAccessor();
...
#endif  // LIB_COMPONENT_SKV_PLAYER_SRC_SENSCORD_CONFIDENCE_CHANNEL_ACCESSOR_H_
