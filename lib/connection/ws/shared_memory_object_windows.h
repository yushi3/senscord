 ...
 */
#ifndef LIB_CONNECTION_WS_SHARED_MEMORY_OBJECT_WINDOWS_H_
#define LIB_CONNECTION_WS_SHARED_MEMORY_OBJECT_WINDOWS_H_
...
#define CreateSharedMemoryObject() \
  new senscord::ws::SharedMemoryObjectWindows()
...
#endif  // LIB_CONNECTION_WS_SHARED_MEMORY_OBJECT_WINDOWS_H_
