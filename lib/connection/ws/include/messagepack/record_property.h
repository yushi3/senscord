 ...
 */
#ifndef LIB_MESSAGE_PACK_RECORD_PROPERTY_COMPONENT_H_
#define LIB_MESSAGE_PACK_RECORD_PROPERTY_COMPONENT_H_
 ...
 */
class RecordPropertyComponent : public MessagePackPropertyBase {
 public:
  /**
   ...
   * @return instance name.
   */
  std::string GetInstanceName() { return kRecordPropertyKey; }
...
#endif  // LIB_MESSAGE_PACK_RECORD_PROPERTY_COMPONENT_H_
