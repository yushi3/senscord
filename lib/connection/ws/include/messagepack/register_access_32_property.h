 ...
 */
#ifndef LIB_MESSAGE_PACK_REGISTER_ACCESS_32_PROPERTY_COMPONENT_H_
#define LIB_MESSAGE_PACK_REGISTER_ACCESS_32_PROPERTY_COMPONENT_H_
 ...
 */
class RegisterAccess32PropertyComponent : public MessagePackPropertyBase {
 public:
  /**
   ...
   * @return instance name.
   */
  std::string GetInstanceName() { return kRegisterAccess32PropertyKey; }
...
#endif  // LIB_MESSAGE_PACK_REGISTER_ACCESS_32_PROPERTY_COMPONENT_H_
