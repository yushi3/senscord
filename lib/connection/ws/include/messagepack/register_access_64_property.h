 ...
 */
#ifndef LIB_MESSAGE_PACK_REGISTER_ACCESS_64_PROPERTY_COMPONENT_H_
#define LIB_MESSAGE_PACK_REGISTER_ACCESS_64_PROPERTY_COMPONENT_H_
 ...
 */
class RegisterAccess64PropertyComponent : public MessagePackPropertyBase {
 public:
  /**
   ...
   * @return instance name.
   */
  std::string GetInstanceName() { return kRegisterAccess64PropertyKey; }
...
#endif  // LIB_MESSAGE_PACK_REGISTER_ACCESS_64_PROPERTY_COMPONENT_H_
