 ...
 */
#ifndef LIB_MESSAGE_PACK_REGISTER_ACCESS_08_PROPERTY_COMPONENT_H_
#define LIB_MESSAGE_PACK_REGISTER_ACCESS_08_PROPERTY_COMPONENT_H_
 ...
 */
class RegisterAccess08PropertyComponent : public MessagePackPropertyBase {
 public:
  /**
   ...
   * @return instance name.
   */
  std::string GetInstanceName() { return kRegisterAccess8PropertyKey; }
...
#endif  // LIB_MESSAGE_PACK_REGISTER_ACCESS_08_PROPERTY_COMPONENT_H_
