 ...
 */
#ifndef LIB_OSAL_COMMON_OSAL_ERROR_H_
#define LIB_OSAL_COMMON_OSAL_ERROR_H_
...
enum OSFunctionId {
  ...
  kIdOSGetDynamicLibraryFileName,   // 0x1005
...
#endif  // LIB_OSAL_COMMON_OSAL_ERROR_H_
